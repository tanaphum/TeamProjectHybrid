     ...
     constructor(props)
  {
    ...
    return (
        ...
        <View style={{alignItems: 'center', backgroundColor: '#ffccee'}}>
          ...
          <Text style={styles.button}>empty plastic bottle            plastic bag </Text>
          <Text style={styles.button}>empty glass            broken glass </Text>
          <Text style={styles.button}>metal            empty can </Text>
          <Text style={styles.button}>empty berverage container        piece of paper</Text>
