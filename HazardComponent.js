     ...
     constructor(props)
  {
    ...
    return (
        ...
        <View style={{alignItems: 'center', backgroundColor: '#ffccee'}}>
          ...
          <Text style={styles.button}>hazardous container           cosmetics</Text>
          <Text style={styles.button}>cleaning solution            expired medicine </Text>
          <Text style={styles.button}>insecticide            thinner </Text>
          <Text style={styles.button}>engine oils       light bulb</Text>
          <Text style={styles.button}>fluorescent      battery  </Text>
          <Text style={styles.button}>car battery </Text>
