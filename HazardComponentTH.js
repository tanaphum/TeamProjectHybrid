     ...
     constructor(props)
  {
    ...
    return (
       ...
       <View>
          ...
          <Text style={styles.button}>บรรจุภัณฑ์อันตราย           เครื่องสำอาง</Text>
          <Text style={styles.button}>ผลิตภ์ทำความสะอาด            ยาหมดอายุ </Text>
          <Text style={styles.button}>ยากำจัดแมลง            ทินเนอร์ </Text>
          <Text style={styles.button}>น้ำมันเครื่อง      หลอดไฟ</Text>
          <Text style={styles.button}>ถ่าน   ถ่านรถยนต์ </Text>
