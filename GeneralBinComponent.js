     ...
     constructor(props)
  {
    ...
    return (
        ...
        <View style={{alignItems: 'center', backgroundColor: '#ffccee'}}>
          ...
          <Text style={styles.button}>used plastic container             cloth</Text>
          <Text style={styles.button}>straw            instant noodle cup </Text>
          <Text style={styles.button}>candy bag            paper cup </Text>
          <Text style={styles.button}>snack bag       foam box</Text>
          <Text style={styles.button}>instant noodle bag      food box  </Text>
          <Text style={styles.button}>tissue paper </Text>
